...
def test_filter_clues_max_three() -> None:
    from vault.clue_vault import filter_clues
...
def test_sanitize_clue_summary_nav_and_glyphs() -> None:
    from vault.clue_vault import format_summary_for_markdown, sanitize_clue_summary
...
def test_materialize_prefers_agent_summary_no_script_by_default() -> None:
    import tempfile
    from vault.clue_vault import materialize_clues
...
def test_inject_clue_annotations_l1_l4() -> None:
    from vault.clue_vault import inject_clue_annotations
...
def test_feature_callout_drops_orphan_fids() -> None:
    ...
    from vault.clue_vault import inject_clue_annotations, match_clue_to_note
...
def test_repo_obsidian_bases_are_yaml_templates() -> None:
    ...
    assets = PKG / "assets" / "obsidian"
    for stem in ("patents", "glossary"):
...
def test_sanitize_user_facing_titles() -> None:
    from vault.write_patent_obsidian_note import sanitize_user_facing_titles
