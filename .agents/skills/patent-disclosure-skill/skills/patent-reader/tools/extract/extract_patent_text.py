...
用法：
  python skills/patent-reader/tools/extract/extract_patent_text.py -i patent.md -o outputs/patent_reader/run1
  python skills/patent-reader/tools/extract/extract_patent_text.py -i patent.pdf -o tmp/run1 --pub-number CN107785522B
  python skills/patent-reader/tools/extract/extract_patent_text.py -i abstract_only.txt -o tmp/run1 --abstract-only
"""
