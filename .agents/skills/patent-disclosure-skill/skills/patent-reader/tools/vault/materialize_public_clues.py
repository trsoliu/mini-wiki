...
用法：
  python skills/patent-reader/tools/vault/materialize_public_clues.py \\
      --note-rel Research/Patents/领域/CNxxx/CNxxx_解读_20260721.md \\
      --public-clues outputs/patent_reader/RUN/public_clues.json

  # 缺摘要时脚本降级
  python skills/patent-reader/tools/vault/materialize_public_clues.py --note-rel ... --fetch-fallback
"""
