...
用法：
  ...
  # 仅围绕刚入库的公开号
  python skills/patent-reader/tools/vault/link_patent_notes.py --focus-pub CN999999999B

  # 合并 Agent 模型判定（可选 JSON）
  python skills/patent-reader/tools/vault/link_patent_notes.py --model-scores model_links.json
"""
