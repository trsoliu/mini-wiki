...
用法：
  ...
  python skills/patent-reader/tools/vault/setup_obsidian_vault.py --vault D:/Obsidian/MyVault
"""
    ...
    if not vault_s:
        ...
        if resolved.get("vault"):
            ...
            print(
                ...
                "然后：\n"
                '  python skills/patent-reader/tools/vault/check_obsidian_env.py --set "你的库路径"\n'
