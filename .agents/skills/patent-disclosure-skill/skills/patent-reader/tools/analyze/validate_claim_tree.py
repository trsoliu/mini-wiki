...
用法：
  python skills/patent-reader/tools/analyze/validate_claim_tree.py -i claim_tree.json
  python skills/patent-reader/tools/analyze/validate_claim_tree.py -i claim_tree.json --write
  python skills/patent-reader/tools/analyze/validate_claim_tree.py -i claim_tree.json --strict
"""
